...
export class CheckoutPage{
    ...
    inputCardDetailsList:Locator;
    expiryDateDropdown:Locator;
    emailIdGreyed:Locator;
    userNameEmailId:Locator;
    ...
    async selectCountry(countryName:string,countryAcronym:string){
    ...
    async enterPaymentInformation(cardNumber:string,cvv:any,name:string,expiryDate:any,expiryMonth:any){
